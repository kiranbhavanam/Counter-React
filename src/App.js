...
function backHandler(){
  ...
  return (
    <div className="App relative">
      ...
      <i className={`${activeComponent.app==="Counter"?"text-white bg-purple-700":" text-white bg-blue-500 shadow-black"}   border px-4 py-2 rounded-md shadow-sm shadow-white fa-solid fa-arrow-left  absolute top-4 left-8 align-middle hover:cursor-pointer`} onClick={backHandler}><span className="font-serif font-extralight align-middle ml-2 text-center ">Go Back</span></i>
      </div>
